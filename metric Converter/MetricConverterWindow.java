...
public class MetricConverterWindow extends JFrame {
   ...
   private JRadioButton metersButton; // To convert to meters
   private JRadioButton centimetersButton; // To convert to meters
   ...
   private class RadioButtonListener implements ActionListener {
      public void actionPerformed(ActionEvent e) {
...

         {
            // Convert to meters.
            convertTo = " meters.";
            result = Double.parseDouble(input) * 1000.0;
         } else if (e.getSource() == centimetersButton)

         {
            // Convert to centimeters.
            convertTo = " centimeters.";
            result = Double.parseDouble(input) * 100000.0;
         }
